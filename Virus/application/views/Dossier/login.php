      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          <section class="login_content">
            <?= form_open(site_url("Login/Authen"));?>
              <h1>Administrateur - Junior</h1>
              <div>
                <input type="text" name="nom" class="form-control" placeholder="Email Admin Junior ... !" required/>
              </div>
              <span class="text-danger"><?= form_error('nom');?></span>
              <div>
                <input type="password" name="password" class="form-control" placeholder="Mot de Passe Admin Junior ... !" required/>
              </div>
              ...
              <div class="separator">
                <p class="change_link"> Administrateur Junior ?
                ...
                <div>
                  ...
                  <p>©2022 All Rights Reserved. Mr-Jacques! is a Bootstrap 3 template. Privacy and Terms</p>
                </div>
              </div>
            <?= form_close()?>
          </section>
        ...
        <div id="register" class="animate form registration_form">
          <section class="login_content">
            <?= form_open_multipart(site_url("Login/Salacompte"));?>
              ...
              <span class="text-danger"><?= form_error("password");?></span>
              <div>
                <input type="hidden" name="etat" class="form-control" value="1" required="" required/>
              </div>
              <hr>
              <div class="col-md-8">
