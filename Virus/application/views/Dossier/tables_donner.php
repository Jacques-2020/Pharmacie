...
<body class="nav-md">
					...
					<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-desktop"></i> Espace des Ventes <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="<?= site_url('donner/Table_Cosme/Tinda'); ?>">Table-Produits</a></li>
									</ul>
								</li>
								<li>
									<a><i class="fa fa-shopping-bag"></i> Espace des Facturations<span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="<?= site_url('donner/Table_Cosme/ventes'); ?>">Listes ventes</a></li>
									</ul>
								</li>
								...
								<ul class="dropdown-menu list-unstyled msg_list" role="menu" aria-labelledby="navbarDropdown1">
									<li class="nav-item">
										<!-- <a class="dropdown-item">
											...
											<span>
												<span><?= $this->session->NomAdmin; ?></span>
					...
					<div class="page-title">
						...
						<div class="title_center">
							<div class="col-md-5 col-sm-5 col-xs-12 form-group pull-center top_search">
								<?php echo form_open(site_url("donner/Table_Cosme/Tinda")); ?>
	...
	<div class="modal fade" id="mdl-vente" tabindex="-1" role="dialog" aria-labelledby="firefoxModalLabel" aria-hidden="true" data-backdrop='static'>
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="firefoxModalLabel">Nouvelle vente : <span id="nom-article"></span></h4>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
				</div>
				<form id="f-vente" method="post">
					<div class="modal-body font-weight-bold">
						<p>Stock disponible : <span id="stock"></span></p>
						<div class="form-group">
							<label for="">Qté vendue :</label>
							<input name="qte" min="1" class="form-control" type="number" required>
							<input type="hidden" name="idpharma">
						</div>
						<div class="form-group">
							<div id="rep"></div>
						</div>
					...
					<div class="modal-footer">
						...
						<button type="submit" class="btn btn-primary"> <span></span> Enregistrer</button>
					</div>
				</form>
			</div>
		</div>
	...
	<script>
		$(function() {
			$('.vente').click(function() {
				var btn = $(this);
				var modal = $('#mdl-vente');
				$('#nom-article').html(btn.attr('article'));
				$('#stock').html(btn.attr('stock'));
				$('[name=idpharma]', $('#f-vente')).val(this.value)
				modal.modal();
			});

			$('#f-vente').submit(function() {
				...
				rep.slideUp();
				$.post('<?= site_url('ajax/vente') ?>', data, function(res) {
